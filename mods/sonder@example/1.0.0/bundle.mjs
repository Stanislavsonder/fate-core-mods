...
/*$vite$:1*/`)),document.head.appendChild(e)}}catch(e){console.error(`vite-plugin-css-injected-by-js`,e)}})();//#region node_modules/.pnpm/@fate-core+mod-types@0.1.2_vue@3.5.40/node_modules/@fate-core/mod-types/dist/bundle.js
function e(e) {
	return e;
}
function t(e, t) {
